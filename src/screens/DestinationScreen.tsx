  ...
  if (loadingDest || loadingCities) {
    return (
      <div className="min-h-screen bg-ivory-100 flex items-center justify-center">
        <p className="font-display italic text-xl text-terracotta-400">Loading Bali...</p>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-ivory-100 flex items-center justify-center">
        <div className="text-center">
          <p className="font-body text-gray-500 mb-4">Destination not found. Have you run the seed SQL?</p>
  ...
  return (
    <div className="min-h-screen bg-ivory-100">
      ...
      <div className="relative h-72 md:h-96">
        <img
          src={destination.cover_image_url || 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=1200'}
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        {/* Area Tabs */}
        <div className="mb-6">
          <h2 className="font-display text-2xl text-terracotta-700 mb-4">Explore by Area</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {(cities ?? []).map((city) => (
              <button
                key={city.id}
                onClick={() => navigate(`${basePath}/bali/${city.id}`)}
